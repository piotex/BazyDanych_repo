    ...
    public class MoqUsersList : BaseMoqList<Users>
    {
        ...
        public static MoqUsersList GetInstance()
        {
            if (_instance == null)
            {
                ...
                {
                    new Users(){USERSID= 1,BIRTHDAY=DateTime.Now.AddDays(-365*20),COMPANYID= 1,NAME="Peter", LASTNAME= "Tomaszkiewicz",MAIL="pkubon@gmail.com",PHONE="721545820",USERCATEGORYID=2},
